          ...
          <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">            
              ...
              <div className="bg-gray-50 p-4 rounded-xl">
                ...
                <p><span className="font-medium">Updated:</span> {new Date(selectedUser.updatedAt ?? 0).toLocaleString()}</p>
                {selectedUser.deletedAt && (
                  <p className="text-red-600">
                    <span className="font-medium">Deleted:</span> {new Date(selectedUser.deletedAt ?? 0).toLocaleString()}
                  </p>
                )}
              </div>
            </div>            
